...
\section{Dualité}
\begin{definition}
Soit le problème linéaire en forme standard
\[\begin{cases}
\text{Max } z=cx \\
Ax=b \\
x \ge 0
\end{cases}\]
On l'appelera \emph{problème primal}, et le problème
\[\begin{cases}
\text{Min } w=b^Ty\\
A^Ty\ge c^T
\end{cases}\]
sera appelé le \emph{problème dual}, avec \(y=[y_1,\dots,y_m]\in\mathbb{R}^m\)
